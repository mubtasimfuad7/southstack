...
export class UiGenerationService {
            ...
            nodes: [
              {
                ...
                children: [
                  {
                    id: 'header-text', name: 'Text', type: NodeType.TEXT,
                    x: 20, y: 20, width: 200, height: 30, rotation: 0,
                    content: prompt,
                    attributes: { color: '#333333', fontSize: 24 },
                    decorators: [], children: []
                  },
                  {
                    id: 'rect-1', name: 'Rectangle', type: NodeType.RECTANGLE,
                    x: 20, y: 70, width: 360, height: 100, rotation: 0,
  ...
  validateJson(json: any): boolean {
    return !!(json && json.layouts && Array.isArray(json.layouts));
  }
